package com.gyp.jedis.util.chinese;
...
public class ChinesePinyinUtil {
    ...
    private static Logger log = LoggerFactory.getLogger(ChinesePinyinUtil.class);
     ...
     */
    public static String toPinyin(String chineseStr) throws HanyuPinyinConvertException {
        ...
        try {
            ...
            throw new HanyuPinyinConvertException(e);
        }
     ...
     * @param chineseStr 待转换的中文
     */
    public static String getFirstLetters(String chineseStr) throws HanyuPinyinConvertException {
        char[] cl_chars = chineseStr.trim().toCharArray();
